...
LICENSE="metapackage"
SLOT="0"
IUSE="2048 3dengine 4do beetle-psx bnes bsnes bsnes-cpp98 citra craft desmume dolphin easyrpg fbalpha fbalpha2012 fceumm gambatte genplus handy mame mame2000 mame2003 mame2016 mednafen-gba mednafen-ngp \
	mednafen-pce-fast mednafen-saturn mednafen-snes mednafen-supergrafx mednafen-vb mednafen-wswan melonds meowpc98 meteor mgba +mrboom mupen64plus nestopia +nxengine openlara parallel-n64 pcsx-rearmed \
	picodrive snes9x2002 ppsspp +prboom prosystem px68k quicknes redream reicast sameboy scummvm snes9x snes9x2010 stella tgbdual tyrquake vba-next vbam yabause"
...
RDEPEND="2048? ( >=games-emulation/2048-libretro-9999 )
		...
		mednafen-bsnes? ( >=games-emulation/mednafen-bsnes-libretro-9999 )
